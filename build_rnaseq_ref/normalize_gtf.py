...
def insert_gene_name( gtf_file ):
    ...
    with open( gtf_file , "r" ) as gtf:
        ...
        for feature_row in gtf_reader:
            ...
            new_transname = genid.get(TRANS_NAME, DEF_TRANS_NAME).strip(STRIP_QUOTES)
...
if __name__ == "__main__":
   arg_raw = argparse.ArgumentParser(prog="normalize_gtf.py",description="Normalize GTF (insert gene_name where not present.)")
