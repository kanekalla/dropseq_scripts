...
#Author: Karthik Shekhar, 05/05/16
...
#${toolsPath}/DetectBeadSynthesisErrors I=${baseDir}/bams/${bamName}_old.bam O=${baseDir}/bams/${bamName}_unmerged.bam OUTPUT_STATS=${baseDir}/synthesis_err_stats/${bamName}.synthesis_stats.txt SUMMARY=${baseDir}/synthesis_err_stats/${bamName}.synthesis_stats.summary.txt NUM_BARCODES=$((numCells*2)) PRIMER_SEQUENCE=AAGCAGTGGTATCAACGCAGAGTAC MAX_NUM_ERRORS=2 CELL_BARCODE_TAG=XC
...
#${toolsPath}/CollapseBarcodesInPlace I=${baseDir}/bams/${bamName}.bam O=${baseDir}/bams/${bamName}_collapsed.bam PRIMARY_BARCODE=XC OUT_BARCODE=ZC MIN_NUM_READS_CORE=5000 MIN_NUM_READS_NONCORE=1000 EDIT_DISTANCE=1
...
#summary
#${toolsPath}/BAMTagofTagCounts I=${baseDir}/bams/${bamName}.bam O=${baseDir}/bam_reads/${bamName}.collapse_stats.txt PRIMARY_TAG=ZC SECONDARY_TAG=XC

#STEP 4: Bam Tag Histogram
#${toolsPath}/BAMTagHistogram I=${baseDir}/bams/${bamName}.bam O=${baseDir}/bam_reads/${bamName}.reads.txt.gz TAG=ZC
...
#sed "s/fileName/${temp1}/g;s/figName/${temp2}/g" < ${baseDir}/scripts/DropSeqCumuPlot.R > ${baseDir}/scripts/run_files/DropSeqCumuPlot_${bamName}.R
#R CMD BATCH ${baseDir}/scripts/run_files/DropSeqCumuPlot_${bamName}.R DropSeqCumuPlot_${bamName}.out
...
#R CMD BATCH ${baseDir}/scripts/run_files/collect_cell_barcodes.${bamName}.R

#STEP 6: DGE UMIs
${toolsPath}/DigitalExpression I=${baseDir}/bams/${bamName}.bam O=${baseDir}/UMI_DGE/${bamName}.umi.dge.txt.gz SUMMARY=${baseDir}/UMI_DGE/${bamName}.umi.dge.summary.txt CELL_BARCODE_TAG=ZC NUM_CORE_BARCODES=${numCells}

#STEP 7: DGE READS
${toolsPath}/DigitalExpression I=${baseDir}/bams/${bamName}.bam O=${baseDir}/reads_DGE/${bamName}.reads.dge.txt.gz SUMMARY=${baseDir}/reads_DGE/${bamName}.reads.dge.summary.txt CELL_BARCODE_TAG=ZC NUM_CORE_BARCODES=${numCells} OUTPUT_READS_INSTEAD=true
