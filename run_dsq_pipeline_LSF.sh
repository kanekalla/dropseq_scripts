...
b=${b0/_R1/}
sed "s|fName|${b}|g;s|fastq1|${fq1}|g;s|fastq2|${fq2}|g;s|bamFileName|${b}|g;s|numCellsNum|${numCells[l]}|g;s|refFasta|${refFastaPath}|g;s|metaDataLoc|${metaDataDir}|g;s|basedir|${baseDir}|g" < run_Alignment_LSF.sh > run_Alignment_LSF_${b}.sh
chmod +x run_Alignment_LSF_${b}.sh
mv run_Alignment_LSF_${b}.sh run_files

bsub -oo ../bsub_logs/${b}.pipe.log -eo ../bsub_logs/${b}.pipe.err -q ${queue} -R "rusage[mem=150]span[hosts=1]" \
./run_files/run_Alignment_LSF_${b}.sh
